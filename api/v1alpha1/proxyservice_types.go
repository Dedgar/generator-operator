...
type ProxyServiceSpec struct {
	...
	// Foo is an example field of ProxyService. Edit ProxyService_types.go to remove/update
...
type ProxyService struct {
	...
	Spec   ProxyServiceSpec   `json:"spec,omitempty"`
	Status ProxyServiceStatus `json:"status,omitempty"`
}
...
func init() {
	SchemeBuilder.Register(&ProxyService{}, &ProxyServiceList{})
}
